...
<section class="hero-pastel relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-16 pb-0 md:pt-20">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-end">
            {{-- Left: Text --}}
            <div class="pb-16 md:pb-20">
                <div class="badge-pill mb-6">
                    <span class="w-2 h-2 rounded-full bg-[#8BAF89] pulse-soft inline-block"></span>
                    Layanan Kebun &amp; Pertanian Terpadu
                </div>
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#2E4A2C] leading-[1.1] mb-5">
                    Solusi Agribisnis<br>
                    <span class="text-[#C28060]">dari Hulu</span><br>
                    <span class="text-[#C28060]">hingga Hilir</span>
                </h1>
                <p class="text-[#4A6348] text-lg leading-relaxed mb-8 max-w-md">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('konsultasi.index') }}" class="inline-flex items-center gap-2 bg-[#4A7A48] hover:bg-[#3B6039] text-white font-bold px-7 py-3.5 rounded-2xl shadow-md hover:shadow-lg transition-all hover:-translate-y-0.5 text-sm">
                        Mulai Konsultasi Sekarang →
                    </a>
                    <a href="#layanan-grid" class="inline-flex items-center gap-2 border-2 border-[#8BAF89] text-[#3B6039] hover:bg-[#EBF4EA] font-bold px-7 py-3.5 rounded-2xl transition-all text-sm">
                        Lihat Semua Layanan ↓
                    </a>
                </div>
            </div>
        ...
        <div class="relative overflow-hidden rounded-3xl border border-[#C8DEC6] shadow-sm">
            ...
            <div class="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-0">
                ...
                <div class="p-8 sm:p-12">
                    <span class="inline-block bg-white/80 text-[#3B6039] text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider mb-4 border border-[#C8DEC6]">
                        🪴 Solusi Fleksibel &amp; Kustom
                    </span>
                    <h2 class="text-2xl sm:text-3xl font-extrabold text-[#2E4A2C] mb-4 leading-tight">
                        Butuh Paket Khusus<br>untuk Kebun Anda?
                    </h2>
                    <p class="text-[#4A6348] text-base leading-relaxed mb-8">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $adminPhone) }}?text=Halo%20Hallobun%2C%20saya%20ingin%20paket%20layanan%20kustom"
                           ...
                           class="inline-flex items-center gap-2.5 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold px-7 py-3.5 rounded-2xl shadow-md hover:shadow-lg transition-all hover:-translate-y-0.5 text-sm">
                        ...
                        <a href="{{ route('kunjungan.index') }}"
                           class="inline-flex items-center gap-2 bg-white hover:bg-[#EBF4EA] text-[#3B6039] border-2 border-[#8BAF89] font-bold px-7 py-3.5 rounded-2xl transition-all text-sm hover:-translate-y-0.5">
                            Ajukan Survei Kebun →
                        </a>
                    </div>
                </div>
